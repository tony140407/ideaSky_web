<template>
  <div class="chart_group">
    <div class="row">
      <div class="col-xl-6" id="chart1" style="height:50vh"></div>
      <div class="col-xl-6" id="chart4" style="height:50vh"></div>
    </div>
    <div class="row">
      <div class="col-xl-6" id="chart2" style="height:50vh"></div>
      <div class="col-xl-6" id="chart3" style="height:50vh"></div>
    </div>
    <div class="row">
      <div class="col-xl-6" id="chart6" style="height:50vh"></div>
      <div class="col-xl-6" id="chart5" style="height:50vh"></div>
    </div>
  </div>
</template>
<script>
export default {
  created: function() {
    ...
    document
      ...
      .addEventListener("click", timeVarClick);
    document
      .querySelector("#yesterdayOption")
      .addEventListener("click", timeVarClick);
    document
      .querySelector("#thisWeekOption")
      .addEventListener("click", timeVarClick);
    document
      .querySelector("#thisMonthOption")
      .addEventListener("click", timeVarClick);
    ...
    document
      .querySelector("#showMoreDataModalBtn")
    ...
    document
      .querySelector("#showMoreAlarmModalBtn")
      .addEventListener("click", function() {
        document.querySelector(`#innerAlarmTBody`).innerHTML = "";
        if (window.dataAerobox == "") {
          document.querySelectorAll(".gateway-alarm-area").forEach(function(e) {
